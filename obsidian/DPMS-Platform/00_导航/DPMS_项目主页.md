...
- 当前运行版本：`v9.0-local`（V5.5 Experiment / V6 Risk Intelligence / V6.5 Learning / V7 Governance / V8 Transition / V9 Semantic Runtime 已落地）
- 当前优先平台：Bilibili
...
- 测试基线：core **200 项**（94 + 26 + 15 + 14 + 15 + 19 + 10 + 7）+ worker 21 项单元测试通过
